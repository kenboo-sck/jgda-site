      ...
      <section className="bg-white pt-6 pb-2">
        <div className="max-w-[1200px] mx-auto px-4 xl:px-0">
          <div className="relative bg-[#001f3f] rounded-sm shadow-2xl p-4 md:p-6 border-l-4 border-red-600 overflow-hidden group/container">
            ...
            <div className="relative w-full flex flex-col gap-4 lg:gap-6 items-center z-10">
              <div className="w-full text-center flex flex-col items-center">
                <div className="inline-flex items-center gap-2 mb-2 justify-center">
                  ...
                  <span className="text-red-400 font-mono text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase">Special Live Streaming</span>
                </div>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-white tracking-widest drop-shadow-md leading-tight italic mb-2 md:mb-4">
                  <span className="block text-slate-400 text-[10px] md:text-xs lg:text-sm font-bold tracking-[0.2em] mb-1.5 not-italic">東京建物 Brillia CUP</span>
                  東京建物 Brillia CUP <span className="text-red-500">ライブ配信</span>はこちら！
                </h2>

                <div className="inline-flex relative mt-1 mb-2 group">
                  ...
                  <div className="relative flex items-center bg-slate-900 border border-red-500/50 px-4 py-2 rounded-full shadow-[0_0_15px_rgba(239,68,68,0.25)] backdrop-blur-md">
                    <div className="flex items-center gap-2 md:gap-3">
                      <div className="bg-red-500/20 p-1.5 rounded-full hidden sm:block">
                      ...
                      <div className="flex flex-col text-center sm:text-left">
                        <span className="text-slate-400 font-mono text-[8px] md:text-[9px] tracking-[0.3em] uppercase leading-none mb-1">
                          Date & Time
                        </span>
                        <div className="flex items-baseline justify-center sm:justify-start gap-1">
                          <span className="text-white text-sm md:text-base font-bold tracking-widest leading-none">
                            2026年6月17日<span className="text-red-400 font-medium ml-1 text-xs">（水）</span>
                          </span>
                        </div>
                      </div>
                    </div>
              ...
              <div className="w-full max-w-xl mx-auto flex justify-center">
                <Link href="https://player.yourlive.jvckenwood.com/jgda/20260617_jgda.html" target="_blank" rel="noopener noreferrer" className="w-full block overflow-hidden rounded shadow-xl hover:shadow-[0_0_30px_rgba(239,68,68,0.4)] transition-all duration-300 border border-white/10 group bg-slate-900 border-b-2 border-b-red-600/50 hover:border-b-red-500">
                  <Image src={liveBanner} alt="Live Streaming" className="w-full h-auto object-cover group-hover:scale-[1.01] transition-transform duration-700 ease-out opacity-95 group-hover:opacity-100" />
                </Link>
              </div>
            </div>
          </div>
